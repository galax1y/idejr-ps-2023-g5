...
export default function FormSection() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className='whitespace-nowrap py-6 text-center text-[30px] text-idePurple'>
          Envie uma mensagem para nós:
        </h2>

        <input
          onChange={(event) => setPokemonName(event.target.value)}
          className='border-2 border-idePurple px-3 py-6 text-2xl placeholder-idePurple/80'
